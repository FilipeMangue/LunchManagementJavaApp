 ...
 */
public class VisionDevolucao extends javax.swing.JFrame {

    /**
     * Creates new form VisionDevolucao
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Por Venda");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setText("Por Cliente");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel4.setText("Por Data");
        ...
        jLabel1.setText("Escolha a Venda:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        VsionSelectClient vsc = new VsionSelectClient();
        vsc.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        VisionSelectProduct vsp = new VisionSelectProduct();
        vsp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisionDevolucao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisionDevolucao().setVisible(true);
            }
        });
    }
